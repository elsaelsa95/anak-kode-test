...
export const DataArticleEnglish: IArticle[] = [
    {
        title: "Reduce Noise Pollution",
        description:
            "The electric engine in a car works with electricity which does not produce the noisy sound of an internal combustion engine.",
        image: "/image/noise.png",
    },
    {
        title: "Reduce Air Pollution",
        description:
            "Electric cars do not produce carbon dioxide emissions and other gases that contribute to global warming and climate change.",
        image: "/image/pollution.png",
    },
    {
        title: "Reduce the Use of Fuel",
        description:
            "Electric cars can reduce dependence on increasingly limited fuel oil.",
        image: "/image/fuel.png",
    },
];

export const DataArticleIndonesian: IArticle[] = [
    {
        title: "Mengurangi Polusi Suara",
        description:
            "Mesin listrik pada mobil bekerja dengan tenaga listrik yang tidak menghasilkan suara bising seperti mesin pembakaran dalam.",
        image: "/image/noise.png",
    },
    {
        title: "Mengurangi Polusi Udara ",
        description:
            "Mobil listrik tidak menghasilkan emisi karbon dioksida dan gas lain yang berkontribusi terhadap pemanasan global dan perubahan iklim.",
        image: "/image/pollution.png",
    },
    {
        title: "Mengurangi Penggunaan Bahan Bakar Minyak",
        description:
            "Mobil listrik dapat mengurangi ketergantungan terhadap bahan bakar minyak yang semakin terbatas.",
        image: "/image/fuel.png",
    },
];
...
export const DataBrandingEnglish: IBranding[] = [
    {
        id: 1,
...
export const DataBrandingIndonesian: IBranding[] = [
    {
        id: 1,
        description: "Kendaraan Siap Pakai",
        count: "1000+",
    },
    {
        id: 2,
        description: "Kantor di Dunia",
        count: "30+",
    },
    {
        id: 3,
        description: "Tahun Jaminan Garansi",
        count: "10+",
    },
    {
        id: 4,
        description: "Konsumen Puas",
        count: "400+",
    },
];
...
export const DataCarList: ICarList[] = [
    {
        ...
        description: {
            ...
            battery:
                "Lithium-ion battery pack: Various capacities available (typically around 64 kWh)",
            charging: {
                standardCharging: "AC charging (Type 2 connector)",
                fastCharging: "DC fast charging (up to 100 kW)",
            },
            interiorAndFeatures:
                "Modern interior with tech features including touchscreen infotainment system, digital instrument cluster, and various driver assistance systems.",
        },
    },
    {
        id: 2,
        ...
        description: {
            ...
            interiorAndFeatures:
                "Comfortable and efficient interior design with ample cargo space and modern infotainment system.",
        },
    },
    {
        id: 3,
        ...
        description: {
            ...
            interiorAndFeatures:
                "Futuristic interior with adjustable seats and a spacious cabin, featuring advanced technology including augmented reality heads-up display (AR HUD) and a large touchscreen infotainment system.",
        },
    },
    {
        id: 4,
        ...
        description: {
            ...
            motorAndPerformance: {
                ...
                range:
                    "Varies, typically around 120-170 km (75-105 miles) on a single charge",
            },
            battery: "Lithium-ion battery pack",
            charging: {
                standardCharging: "AC charging (household socket)",
                fastCharging:
                    "DC fast charging (up to 80% in about 50 minutes to 1 hour)",
            },
            interiorAndFeatures:
                "Basic interior suitable for urban commuting, seating for up to four passengers, minimalist design.",
        },
    },
    {
        id: 5,
        ...
        description: {
            ...
            interiorAndFeatures:
                "Spacious interior with seating for up to five passengers. Modern infotainment system and connectivity features. Advanced driver assistance systems (ADAS) for enhanced safety",
        },
    },
    {
        id: 6,
        ...
        description: {
            ...
            interiorAndFeatures:
                "Premium interior with Lexus' signature craftsmanship and luxury amenities. Advanced infotainment system and driver assistance features",
        },
    },
    {
        id: 7,
        ...
        description: {
            ...
            interiorAndFeatures:
                "Retains the iconic MINI design with a modern interior and premium materials. MINI Connected infotainment system with navigation and digital instrument cluster. Driver assistance systems and safety features typical of modern MINI models",
        },
    },
];